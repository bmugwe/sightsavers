    ...
    if (visuals.length > 1) {
      return (
        <Container fluid>
          <Row fluid>
            <Col>
              <iframe src={site_app+visuals[0]?.id} frameBorder="5" style={{ width: '100%', height: '100%', border: 'none' }}></iframe>
            </Col>
            <Col>
            <iframe src={site_app+visuals[1]?.id} frameBorder="5" style={{ width: '100%', height: '100%', border: 'none' }}></iframe>
            </Col>
          </Row>
        </Container>
      );
